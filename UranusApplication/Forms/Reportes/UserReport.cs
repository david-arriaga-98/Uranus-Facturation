...
namespace ProyectoPuntoNet.Forms.Reportes
{
    public partial class UserReport : Form
    {
        ...
        {
            // TODO: esta línea de código carga datos en la tabla 'projectDataSet.Reporte_Usuario' Puede moverla o quitarla según sea necesario.
            this.reporte_UsuarioTableAdapter.Fill(this.projectDataSet.Reporte_Usuario);
